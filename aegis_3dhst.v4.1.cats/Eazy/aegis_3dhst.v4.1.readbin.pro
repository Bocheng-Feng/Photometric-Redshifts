...
; Template & catalog fluxes
 openr,lun,'aegis_3dhst.v4.1/aegis_3dhst.v4.1_rferrors.tempfilt',/swap_if_big_endian,/get_lun
...
; 
; Coeffs (OBS_SED)
 openr,lun,'aegis_3dhst.v4.1/aegis_3dhst.v4.1.coeff',/get_lun,/swap_if_big_endian
 s = lonarr(4) & readu,lun,s
 NFILT=s[0] & NTEMP = s[1] & NZ = s[2] & NOBJ = s[3]
...
; Full templates (TEMP_SED)
 openr,lun,'aegis_3dhst.v4.1/aegis_3dhst.v4.1.temp_sed',/get_lun,/swap_if_big_endian
...
; 
; POFZ
 openr,lun,'aegis_3dhst.v4.1/aegis_3dhst.v4.1.pz',/get_lun,/swap_if_big_endian
...
; 
; Stored z values
 openr,lun,'aegis_3dhst.v4.1/aegis_3dhst.v4.1.zbin',/get_lun,/swap_if_big_endian
